...
def coref_resolver():
    ...
    with open('Resolved_The_Adv_Blue_Carbuncle.txt','w') as f:
...
def global_relation_builder(var):
    ...
    with open('global_relations_from_sentences.json','w') as f:
...
def temporal_relation_builder(var):
    ...
    with open('temporal_relations_from_sentences.json','w') as f:
         json.dump(sentence_relations, f)
    return sentence_relations
